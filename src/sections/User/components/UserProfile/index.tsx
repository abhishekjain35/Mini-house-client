      ...
      onCompleted: (data) => {
        if (data && data.disconnectStripe) {
          ...
          displaySuccessNotification(
            ...
            "You'll have to reconnect to Stripe to continue to create listings."
          );
          handleUserRefetch();
        }
      },
  ...
  const additionalDetails = user.hasWallet ? (
    <>
      ...
      <Paragraph>
        Income Earned:{" "}
        <Text strong>
          {user.income ? roundListingPrice(user.income) : "$0"}
        </Text>
      </Paragraph>
      <Button
        type="primary"
    ...
    <>
      <Paragraph>
        Interested in becoming a MiniHouse host? Register with your Stripe
        account!
      </Paragraph>
      <Button
        type="primary"
