    ...
    >
      <div className="listing-booking-modal">
        ...
        <div className="listing-booking-modal__charge-summary">
          <Paragraph>
            {roundListingPrice(price, false)} * {daysBooked} days ={" "}
            <Text strong>{roundListingPrice(listingPrice, false)}</Text>
          </Paragraph>
          <Paragraph className="listing-booking-modal__charge-summary-total">
            Total = <Text mark>{roundListingPrice(listingPrice, false)}</Text>
          </Paragraph>
        </div>
